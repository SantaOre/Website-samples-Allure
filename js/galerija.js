...
if(galleryImages) {
    ...
    galleryImages.forEach(function(image, index) {
        image.onclick = function() {
            ...
            let getImgUrlPos = getFullImgUrl.split("/img/otras/");
            ...
            newImg.onload = function(){
                ...
                let btnNextText = document.createTextNode("Nākamā");
                newNextBtn.appendChild(btnNextText);
                container.appendChild(newNextBtn);
                newNextBtn.setAttribute("class", "img-btn-Nākamā");
                newNextBtn.setAttribute("onclick", "changeImg(1)");
                newNextBtn.style.cssText = "right: " + calcImgToEdge + "px;";

                let newPrevBtn = document.createElement("a");
                let btnPrevText = document.createTextNode("Iepriekšējā");
                newPrevBtn.appendChild(btnPrevText);
                container.appendChild(newPrevBtn);
                newPrevBtn.setAttribute("class", "img-btn-Iepriekšējā");
...
function closeImg() {
    ...
    document.querySelector(".img-btn-Nākamā").remove();
    document.querySelector(".img-btn-Iepriekšējā").remove();
}
...
function changeImg(changeDir) {
    ...
    newImg.onload = function(){
        ...
        let nextBtn = document.querySelector(".img-btn-Nākamā");
        nextBtn.style.cssText = "right: " + calcImgToEdge + "px;";

        let prevBtn = document.querySelector(".img-btn-Iepriekšējā");
